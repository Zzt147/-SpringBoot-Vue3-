...
INSERT INTO `t_article` VALUES (24, '有个奇怪的bug', NULL, '<p>读取id为22以前(包括22)的文章可以正常读取但是22以后的就不能了</p>', '2025-12-17 22:46:34', NULL, '默认分类', '', 1, '/api/images/6.png', NULL);
INSERT INTO `t_article` VALUES (25, '2121', NULL, '<p>2121</p>', '2025-12-17 23:52:15', NULL, '默认分类', '', 1, '/api/images/6.png', NULL);
INSERT INTO `t_article` VALUES (26, '测试', NULL, '<p>实测</p>', '2025-12-17 23:55:10', '2025-12-18 05:40:43', '默认分类', '', 1, '/api/images/6.png', NULL);
INSERT INTO `t_article` VALUES (27, '123', NULL, '<p>23</p>', '2025-12-18 00:15:27', NULL, '默认分类', '', 1, '/api/images/6.png', NULL);
INSERT INTO `t_article` VALUES (28, '123', NULL, '<p>23</p>', '2025-12-18 00:15:55', NULL, '默认分类', '', 1, '/api/images/6.png', NULL);
INSERT INTO `t_article` VALUES (29, '新年快乐', NULL, '<p>新年快乐!!!</p>', '2026-01-02 04:13:52', NULL, '默认分类', '', 1, '/api/images/6.png', NULL);
INSERT INTO `t_article` VALUES (30, 'IP测试', NULL, '<p>新增了显示ip功能,看看能不能成功</p>', '2026-01-02 17:43:31', NULL, '默认分类', '', 1, '/api/images/6.png', NULL);
...
CREATE TABLE `t_op_log`  (
  ...
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 100 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_0900_ai_ci COMMENT = '用户操作日志表' ROW_FORMAT = DYNAMIC;
...
CREATE TABLE `t_reply`  (
  ...
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 20 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_0900_ai_ci COMMENT = '子评论/回复表' ROW_FORMAT = DYNAMIC;
...
INSERT INTO `t_statistic` VALUES (23, 26, 3, 0);
...
INSERT INTO `t_statistic` VALUES (27, 30, 5, 0);
